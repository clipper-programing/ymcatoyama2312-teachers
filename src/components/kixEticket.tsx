export default function kixEticket() {
    return (
        <>
            <style
                                ...
                                <div className="flex-auto justify-evenly">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center  my-1">
                                            ...
                                            <h2 className="font-medium">Cathay Pacific</h2>
                                        </div>
                                        <div className="ml-auto text-blue-800">A350-1000</div>
                                    </div>
                                    ...
                                    <div className="flex items-center">
                                        <div className="flex flex-col">
                                            ...
                                            <div className="text-xs">Hong Kong</div>
                                        </div>
                                        ...
                                        <div className="flex flex-col ">
                                            ...
                                            <div className="text-xs">Johannesburg</div>
                                        </div>
                                    </div>
                                    <div className="border-b border-dashed border-b-2 my-5 pt-5">
                                        <div className="absolute rounded-full w-5 h-5 bg-blue-900 -mt-2 -left-2" />
                                        <div className="absolute rounded-full w-5 h-5 bg-blue-900 -mt-2 -right-2" />
                                    </div>
                                    <div className="flex items-center mb-5 p-5 text-sm">
                                        <div className="flex flex-col">
                                            <span className="text-sm">Flight</span>
                                            <div className="font-semibold">CX120</div>
                                        </div>
