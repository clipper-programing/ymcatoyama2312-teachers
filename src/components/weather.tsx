export default function weather() {
    return (
        <>
            <div className="w-1/2 p-5 pt-20 pl-20">
                <div className="p-5 bg-white rounded-md">
                    <div className="max-w-md p-8 mx-auto rounded-lg dark:bg-gray-900 dark:text-gray-100 border-solid border-black">
                        <h2 className="text-2xl font-semibold text-white dark:text-white mb-10 bg-black p-4">目的地の天気</h2>
                        <div className="flex justify-between space-x-8">
                            <div className="flex flex-col items-center">
                                ...
                                <h1 className="text-2xl font-bold">ヨハネスブルグ</h1>
                            </div>
                            <span className="font-bold text-8xl">28°</span>
                        </div>
